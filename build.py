...
<div class="card"><h3>Officetrader</h3><p>Officetrader verzorgt bedrijfsontruimingen, waarbij kantoren en bedrijfspanden compleet en efficiënt worden leeggemaakt.</p><p style="margin-top:10px"><a href="https://officetrader.nl/bedrijfsontruimingen/" target="_blank" rel="noopener">Bedrijfsontruiming</a></p></div>
</div>
</div></section>"""
    write(path,h+footer())
