...
ARTIKELEN=[
{"slug":'reistijd-meewegen-bij-een-nieuwe-baan',"titel":'Zo weeg je reistijd mee bij het kiezen van een nieuwe baan',"cat":'Ondernemen',"datum":'2026-09-17',"datum_nl":'17 september 2026',"lees":3,
"resume":'Reistijd telt zelden mee in de afweging, terwijl het per jaar om honderden uren gaat. Zo reken je het om naar een bedrag en een keuze.',
"body":[
...
{"slug":'co2-voetafdruk-van-een-organisatie',"titel":'Hoe een CO2-voetafdruk inzicht geeft in de klimaatimpact van een organisatie',"cat":'Ondernemen',"datum":'2026-09-18',"datum_nl":'18 september 2026',"lees":3,
"resume":'Een CO2-voetafdruk maakt zichtbaar waar de uitstoot van een organisatie vandaan komt, en welke maatregelen daadwerkelijk verschil maken.',
"body":[
('plink','Steeds meer organisaties willen hun klimaatimpact verkleinen. Om daadwerkelijk effectieve maatregelen te nemen, is het belangrijk om eerst te weten waar de uitstoot vandaan komt. Een<a href="https://www.ecoras.nl/diensten/co2-voetafdruk-analyses/" target="_blank" rel="noopener">CO2-voetafdruk</a> helpt bedrijven om de uitstoot van broeikasgassen systematisch in kaart te brengen. Daarmee ontstaat een onderbouwd vertrekpunt voor verdere verduurzaming.'),
('h2','Wat is een CO2-voetafdruk?'),
('p','Een CO2-voetafdruk geeft inzicht in de hoeveelheid broeikasgassen die een organisatie, product of activiteit veroorzaakt. Hoewel vaak wordt gesproken over CO2-uitstoot, worden meerdere broeikasgassen omgerekend naar een gezamenlijke eenheid: CO2-equivalenten.'),
('p','Bij een organisatie kan bijvoorbeeld worden gekeken naar energiegebruik, transport, zakelijke reizen, ingekochte producten en andere activiteiten die direct of indirect bijdragen aan de uitstoot.'),
('h2','Directe en indirecte uitstoot'),
('p','Niet alle uitstoot ontstaat op dezelfde plek. Daarom wordt bij het bepalen van een CO2-voetafdruk vaak onderscheid gemaakt tussen verschillende categorieën.'),
('p','Directe emissies kunnen bijvoorbeeld ontstaan door brandstoffen die een organisatie zelf gebruikt. Indirecte emissies ontstaan buiten de eigen organisatie, bijvoorbeeld bij de productie van ingekochte materialen of het transport door leveranciers.'),
('p','Vooral de indirecte uitstoot kan aanzienlijk zijn. Daarom is het belangrijk om bij verduurzaming verder te kijken dan alleen het eigen bedrijfspand of wagenpark.'),
('h2','Waarom meten belangrijk is'),
('p','Zonder betrouwbare gegevens is het lastig om vast te stellen welke verduurzamingsmaatregelen het meeste effect hebben. Een organisatie kan bijvoorbeeld investeren in energiezuinige verlichting, terwijl een veel groter deel van de totale klimaatimpact afkomstig is uit de toeleveringsketen.'),
('p','Door de CO2-voetafdruk eerst in kaart te brengen, kunnen bedrijven prioriteiten stellen. De beschikbare tijd en middelen kunnen vervolgens worden ingezet op de onderdelen waar de meeste winst te behalen valt.'),
('h2','Van meting naar reductie'),
('p','Een CO2-voetafdruk is geen eindpunt. Het belangrijkste doel is om de verkregen inzichten te gebruiken voor concrete verbeteringen. Afhankelijk van de resultaten kunnen bijvoorbeeld energiebesparing, efficiënter transport, andere grondstoffen of een verandering in het productieproces worden onderzocht.'),
('p','Ook het aanpassen van inkoopbeleid kan een belangrijke rol spelen. Wanneer bepaalde materialen een grote klimaatimpact hebben, kan worden onderzocht of alternatieven met een lagere impact beschikbaar zijn.'),
('h2','De rol van de toeleveringsketen'),
('p','Voor veel organisaties ligt een belangrijk deel van de CO2-uitstoot buiten de eigen bedrijfsmuren. Denk aan grondstoffen, halffabricaten, transport en diensten van externe partijen. Samenwerking binnen de keten wordt daarom steeds belangrijker.'),
('p','Door gegevens en kennis met leveranciers en andere ketenpartners te delen, kunnen bedrijven gezamenlijk zoeken naar mogelijkheden om emissies te verminderen. Dit kan bovendien leiden tot innovatie en efficiëntere processen.'),
('h2','Een concreet vertrekpunt voor verduurzaming'),
('plink','Een CO2-voetafdruk kan <a href="https://www.ecoras.nl/diensten/co2-voetafdruk-analyses/" target="_blank" rel="noopener">klimaatimpact inzichtelijk maken</a> en helpt organisaties om verduurzaming gerichter aan te pakken. In plaats van maatregelen te baseren op aannames, ontstaat een onderbouwd beeld van de belangrijkste emissiebronnen.'),
('p','Wie de klimaatimpact van een organisatie structureel wil verminderen, doet er daarom goed aan om eerst de huidige situatie te meten. Vanuit dat inzicht kunnen vervolgens realistische reductiedoelen en effectieve maatregelen worden bepaald.')]},
