...
Site: de6voorondernemers.nl, statische site via `build.py`, gedeployed met Cloudflare Pages.
...
- Geen exacte fiscale bedragen noemen, die wijzigen jaarlijks. Beschrijf de systematiek.
